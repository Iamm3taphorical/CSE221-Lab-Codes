...
public class ProblemH {
    static List<Integer> preOrder(List<Integer> in, List<Integer> post) {
        if (in.isEmpty())
        ...
        List<Integer> leftPre = preOrder(leftIn, leftPost);
        List<Integer> rightPre = preOrder(rightIn, rightPost);
    ...
    public static void main(String[] args) {
        ...
        List<Integer> pre = preOrder(in, post);
        for (int val : pre)
